    ...
    public static class HelperFunctions
    {
        public static void SendEmail(EmailData emailData)
        {
            ...
            using (var smtpClient = new SmtpClient(emailServer, emailPort))
            {
                ...
                var message = new MailMessage(fromAddress, toAddress) { SubjectEncoding = System.Text.Encoding.UTF8, Subject = emailData.Subject, Body = emailData.Body, BodyEncoding = System.Text.Encoding.UTF8 };
